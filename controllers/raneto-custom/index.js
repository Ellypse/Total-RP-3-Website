	...
	getPages: function(activePageSlug) {
		...
		files.forEach(function(filePath){
			...
			if(stat.isDirectory()){
				...
				try {
					var titleFile = fs.readFileSync(raneto.config.content_dir + shortPath +'/title');
...
/**
 *
 * @type {{config: {base_url: string, image_url: string, excerpt_length: number, page_sort_meta: string, category_sort: boolean, content_dir: string, debug: boolean}, _metaRegex: RegExp, cleanString: Function, slugToTitle: Function, processMeta: Function, stripMeta: Function, processVars: Function, getPage: Function, getPages: Function, doSearch: Function}}
 */
